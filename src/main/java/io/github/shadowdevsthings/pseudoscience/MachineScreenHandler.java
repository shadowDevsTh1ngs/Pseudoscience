...
public class MachineScreenHandler extends ScreenHandler {
	...
	public MachineScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate machineData) {
		...
		this.addSlot(new MachineFuelSlot(inventory, 1, 56, 53));
		this.addSlot(new MachineOutputSlot(playerInventory.player, inventory, 2, 116, 35));
...
//		// Our inventory
//		for (m = 0; m < 3 && m < size; ++m) {
//			for (l = 0; l < 3 && l+3*m < size; ++l) {
